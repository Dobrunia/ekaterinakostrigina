    ...
    <div id="maps">
        ...
        <div class="map">
            <div>
                ...
                <h3>+7(921) 755-95-20</h3>
                <a target="_blank" href="https://yandex.ru/maps/2/saint-petersburg/?from=api-maps&ll=30.336701%2C59.934570&mode=poi&origin=jsapi_2_1_77&poi%5Bpoint%5D=30.333191%2C59.935287&poi%5Buri%5D=ymapsbm1%3A%2F%2Forg%3Foid%3D1231161762&z=16.4"><button class="btn" id="showMap2">показать на карте</button></a>
            </div>
            <br>
        ...
        <div class="map">
            <div>
                ...
                <h3></h3>
                <a target="_blank" href="https://yandex.ru/maps/2/saint-petersburg/?from=api-maps&ll=30.322432%2C59.962694&mode=usermaps&origin=jsapi_2_1_77&um=constructor%3A8442b2c336bf53bccc5d89ddcc07a0f2c7e80b9736222e222dfa3a7a757beb6a&z=15"><button class="btn" id="showMap3">показать на карте</button></a>
            </div>
            <br>
